...
$(window).load(function(){
	...
	$('.gallery .thumbs').navs(function(n,_){		
		$('.gallery .pic').sImg(_.href)
	}).navs(0)
	...
	function show_splash(){
		...
		// glob_nav
			// .removeClass('subpages')
			// .addClass('splash')
		glob_nav.removeClass('subpages')
		setTimeout(function(){
			glob_nav.addClass('splash')	
		},500)
	...
	function show_subpages(){
		...
		glob_nav.removeClass('splash')
		setTimeout(function(){
			glob_nav.addClass('subpages')	
		},500)
